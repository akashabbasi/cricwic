# CricWic E-Commerce Shopping App
---

## Introduction
---
Welcome to CricWic, an e-commerce shopping app built using the MERN (MongoDB, Express, React, Node.js) stack and Material-UI (MUI) for the user interface. This project provides both normal user and admin modes, offering a wide range of features to enhance the shopping experience.
...
1.  Clone the repository:
    ```bash
    git clone https://github.com/akashabbasi/cricwic.git
    cd cricwic
    ```
...
## Hosting Complete App on Vercel
