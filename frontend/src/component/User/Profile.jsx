...
const ProfilePage = () => {
  ...
  // Prevent accessing properties of undefined if user state hasn't loaded yet
  if (!user) {
    return null;
  }
      ...
      <div className="profileConatiner">
        <div className="leftCotainer">
          ...
          <div className="profileSection">
            ...
            />
            <div className="leftDetails">
              {/* ⚡ Changed component from <p> to <div> to allow semantic <h5> tags safely nested inside */}
              <Typography component="div" className="profileText">
                <h5 className="profileSubHeading">Name :</h5>
                {user.name}
              </Typography>
              <Typography component="div" className="profileText">
