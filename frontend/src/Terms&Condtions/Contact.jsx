...
const useStyles = makeStyles((theme) => ({
  ...
  SelectOption_contact: {
    ...
    "& .MuiOutlinedInput-root": {
      // Input text color selection fix
    ...
    // Fix selector arrows visibility
    "& .MuiSelect-icon": {
      color: "#000000 !important",
    },
  },
...
// Shared high-priority inline layout style configuration block
// Shared high-priority inline layout style configuration block
const dropdownOverrideProps = {
  PaperProps: {
    sx: {
      backgroundColor: "#ffffff !important", // Forces white menu container
      boxShadow: "0px 5px 15px rgba(0,0,0,0.15) !important",

      // Target the internal list container directly to destroy global <ul> styling leaks
      "& .MuiList-root": {
        backgroundColor: "#ffffff !important",
        padding: "0 !important",
      },

      // Handle the individual drop down items layout explicitly
      "& .MuiMenuItem-root": {
        color: "#000000 !important",           // Stark black text color selection
        backgroundColor: "#ffffff !important",  // Default clean white base background
        padding: "12px 20px !important",

        // Overwrite background when user hovers mouse over options
        "&:hover": {
          backgroundColor: "#f5f5f5 !important",
          color: "#000000 !important",
        },

        // Overwrite styling properties for the active selected item row
        "&.Mui-selected": {
            ...
            <div className={classes.SelectOption_contact}>
              ...
              <FormControl className={classes.formField_contact}>
                <Select
                  ...
                  MenuProps={dropdownOverrideProps}
                >
